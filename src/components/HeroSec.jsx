      ...
      <div className='flex w-[93%] flex-col-reverse md:flex-row justify-between items-center gap-[0.8rem] md:gap-[2rem] md:mt-[2rem]'>
        <div className='flex flex-col items-start gap-[1rem]'>
          <motion.h1
            ...
            whileInView="show"
            viewport={{ once: true }}
            className='font-Circular-Bold text-[2.2rem] tablet-2:text-[2.5rem] mini-desktop:text-[2.8rem] text-txt-black leading-[3.2rem] lg:text-[3rem] lg:leading-[3.5rem] xl:text-[3.5rem] xl:leading-[4.5rem] ml-[-0.25rem]'
          >Discover <span className='text-sec-orange'>Delicious</span> <span className='text-nav-green'>Recipes</span> Instantly!</motion.h1>
          <motion.p
            variants={fadeIn('up', 0.4)}
            initial="hidden"
            whileInView="show"
            viewport={{ once: true }}
            className='font-Circular-Medium tablet-2:text-[1.05rem] xl:text-[1.1rem] text-txt-gray-black'
          >Find the perfect dish with easy step-by-step guides, smart recommendations, and ingredient-based searches. Cook, save, and share your favorites!</motion.p>
          <motion.button
            variants={fadeIn('up', 0.5)}
            initial="hidden"
            whileInView="show"
            viewport={{ once: true }}
            className='flex justify-center items-center font-Circular-Medium bg-btn-green px-[1.2rem] py-[0.6rem] rounded-[1.5rem] text-nav-green gap-[0.7rem] cursor-pointer'
        ...
        <motion.div
          ...
          whileInView="show"
          viewport={{ once: true }}
          className="w-[95%] tablet:w-[75%] tablet-2:w-[75%] md:w-[150%] lg:w-[100%] flex justify-end items-center"
        >
          <img
            src={landingImg}
            className=""
