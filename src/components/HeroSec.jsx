    ...
    <div className='h-auto flex flex-col justify-center items-center w-full px-[2rem] pb-[3rem]'>
      ...
      <div className='flex w-[93%] flex-col-reverse md:flex-row justify-between items-center gap-[0.8rem]'>
        ...
        <div className='flex flex-col items-start gap-[1rem]'>
          ...
          <p className='font-Circular-Medium text-txt-black'>Find the perfect dish with easy step-by-step guides, smart recommendations, and ingredient-based searches. Cook, save, and share your favorites!</p>

          <button className='flex justify-center items-center font-Circular-Medium bg-btn-green px-[1.2rem] py-[0.6rem] rounded-[1.5rem] text-nav-green gap-[0.7rem] cursor-pointer'>
            <p>Explore Recipes</p>
      ...
      <ul className='w-[93%] flex flex-col sm:flex-row items-center justify-center gap-[4rem] mt-[4rem] text-txt-black'>
        ...
        <li className='flex flex-col items-center justify-center text-center'>
          ...
          <p className='font-Circular-Medium mt-[0.5rem]'>Find the perfect dish in seconds! Search by ingredients, cuisine, or dietary preference. No more wondering what to cook!</p>
        ...
        <li className='flex flex-col items-center justify-center text-center'>
          ...
          <p className='font-Circular-Medium mt-[0.5rem]'>Cook with confidence! Follow easy, detailed instructions with images and videos to make every meal a success.</p>
        ...
        <li className='flex flex-col items-center justify-center text-center'>
          ...
          <p className='font-Circular-Medium mt-[0.5rem]'>Your personal cookbook! Save your favorite recipes, get personalized meal recommendations, and create shopping lists effortlessly.</p>
